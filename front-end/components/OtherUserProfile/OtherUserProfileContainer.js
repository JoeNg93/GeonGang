...
import { closeOtherUserProfileModal } from '../../actions/modals_control';
...
class OtherUserProfileContainer extends Component {
  ...
  render() {
    ...
    const { otherUserProfile } = this.props;

    if (_.isEmpty(otherUserProfile)) {
      return null;
    }
    ...
    return (
      <OtherUserProfile
        ...
        myProducts={otherUserProfile.favoriteProducts}
        recommendations={this.recommendations}
        userProfile={otherUserProfile}
        onPressCloseModal={this.props.closeOtherUserProfileModal}
      />
    );
  }
}
